...
Startup `refresh_all_cache(redis)` loads everything. After CUD, **incrementally** refresh — e.g. modifying a role: `await load_role_permissions(redis, role_code="R_HR_MANAGER")` — otherwise users see stale permissions.

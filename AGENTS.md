...
3. **跟规范对齐**：[工程约定清单](#工程约定清单pr-review-checklist) + [docs/fast-soy-admin/standard/](docs/fast-soy-admin/standard/)
...
完整命令清单见 [docs/fast-soy-admin/reference/commands.md](docs/fast-soy-admin/reference/commands.md)。
...
业务模块结构、autodiscover 约定见 [docs/fast-soy-admin/develop/autodiscover.md](docs/fast-soy-admin/develop/autodiscover.md)。
...
完整说明见 [docs/fast-soy-admin/develop/init-data.md](docs/fast-soy-admin/develop/init-data.md)。
...
完整架构、分层职责、关键 core 文件清单见 [docs/fast-soy-admin/getting-started/architecture.md](docs/fast-soy-admin/getting-started/architecture.md) 与 [docs/fast-soy-admin/develop/intro.md](docs/fast-soy-admin/develop/intro.md)。

---

## 工程约定清单（PR review checklist）

> 各项展开见 [docs/fast-soy-admin/develop/](docs/fast-soy-admin/develop/) 与 [docs/fast-soy-admin/standard/](docs/fast-soy-admin/standard/)。
